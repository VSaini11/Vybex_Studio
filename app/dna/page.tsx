...
export default function VybexDNAPage() {
  ...
  const [stats, setStats] = useState<StatisticData>({ foundersTrusted: 0, totalAnalyzed: 0, improvedPercentage: 0 });
  const [testimonials, setTestimonials] = useState<Testimonial[]>([]);

  useEffect(() => {
    getDNAStats().then(res => {
                    ...
                    <div className="flex w-max animate-marquee-left gap-6 hover:[animation-play-state:paused]">
                      ...
                      {[...testimonials, ...testimonials, ...testimonials, ...testimonials, ...testimonials, ...testimonials, ...testimonials, ...testimonials].map((t, idx) => (
                        ...
                        >
                          ...
                          <p className="text-purple-100/90 text-[15px] leading-relaxed font-light">
