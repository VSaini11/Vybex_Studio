  ...
  return (
    <section className="relative w-full overflow-hidden py-16 sm:py-24 border-y border-white/5 bg-[#050505]/80 backdrop-blur-md">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {winnerReviews && winnerReviews.length > 0 && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {winnerReviews.map((review, i) => (
                <motion.div
                  ...
                  className="group relative p-6 rounded-3xl bg-zinc-900/30 border border-white/5 hover:border-emerald-500/20 transition-all hover:bg-zinc-900/50"
                >
